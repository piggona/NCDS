...
from Spider.utils.get_proxy import *
...
def get_request(requestId):
    ...
    request = {"requestId":requestId,"appsid":"ffd2bb8b","device":get_device(),"Network":get_network(),"contentParams":get_contentParams(1,catIds)}
    return request